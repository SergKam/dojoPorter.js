 ...
 */
var fs = require("fs");
var fileName = process.argv[2]; //'./dcd/Graph/LoadBalancer.js',
var outputName = process.argv[3] || fileName; //'./dcd/Graph/LoadBalancer.js',
...
//console.log(defineRegexp.exec(text));
